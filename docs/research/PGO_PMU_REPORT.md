...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 44.243 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=12, TSC=10318871710316)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.4859 us/op (824.5 cycles/op)
   * Battery physics calc   : 0.2210 us/op
   * Full-scope E2E pipeline: 0.8324 us/op (1412.4 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1703 us/op
   * Average CPU Cycles    : 289.0 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 25.32 ns/op
   * Average Cycles  : 43.0 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 [ORACLE GATE] Lazy FD Bypass Latency (50000 iters):
   * Average Latency : 6.66 ns/op
   * Average Cycles  : 11.3 cycles/op
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 1731us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0544 us/op
   * Average Cycles  : 92.3 cycles/op
...
--- [REF-TEST-038] Desktop Tray Client Extreme Optimization Oracle Gate ---
 ...
 [ORACLE GATE] 500ms Hover Hysteresis Zero-Syscall Bypass Latency (100000 iters):
   * Average Latency : 32.47 ns/op
   * Average Cycles  : 55.1 cycles/op
 [ORACLE GATE] ToolTip Render Latency with BAR_LUT & Fast Sanitizer (20000 iters):
   * Average Latency : 0.050 us/op
   * Average Cycles  : 85.2 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 576.89 us/op (978874.06 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 17.31 us/op (29372.57 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 16.88 us/op (28644.71 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.97 ns/op (5.03 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 3.64 ns/op (6.18 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 8.42 ns/op (14.28 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 63.3 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=60345602 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 [ORACLE GATE] O(1) L10n Translation Latency (100000 iters):
   * Average Latency : 5.1 ns/op
 [PASS] test_multilingual_l10n_and_auto_system_locale (REF-TEST-041: 13 languages,[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475580 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3475584 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:24:40] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=20.73, profile=Performance; re-asserted ceiling and platform_profile (REF-REQ-112.10)
 46 strings, POSIX auto-detect verified)
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.0512 us/op
   * Average Cycles  : 86.8 cycles/op
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0513 us/op
   * Average Cycles  : 87.1 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 32124.7 us
   * Average Latency : 16.0624 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 16.0624 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.6983 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 11.6044 ns/op
 ...
 [ORACLE GATE] Power Share Decomposition Math (100k iters): 0.0004 ns/op
 [PASS] test_circular_power_share_visualization (REF-TEST-025: Sum-invariant 100%, zero-division safety, < 100ns math verified)
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 8.0995 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1641.8573 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   - CPU Temp: 67.875000 C
   - CPU Cores Online: 16, Avg Freq: 2692 MHz
   - C-State POLL=29448768965us, C1=44528874270us, C2=465471009508us, C3=4182939412098us
   - GPU Power: 12.000000 W
   - GPU Busy: 43%
   - Fan RPM: 5602
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1560045359
 ...
 [ORACLE GATE] 100k stat parses completed in 18773 us (0.1877 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          2,109.87 msec task-clock:u                                                          
     4,587,404,756      cycles:u                                                                (85.76%)
     9,589,029,034      instructions:u                                                          (85.87%)
         7,455,021      cache-misses:u                                                          (85.73%)
        61,696,746      L1-dcache-load-misses:u                                                 (85.68%)
           607,962      dTLB-load-misses:u                                                      (85.69%)
     2,272,348,671      branches:u                                                              (85.72%)
        13,460,112      branch-misses:u                                                         (85.57%)

       2.248882300 seconds time elapsed

       1.644462000 seconds user
       0.425412000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6057 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m117.03 Joules[0m[2m | Monitored Processes: [0m[1m216[0m[2m | Wakeups: [0m[1m2282 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m19.92 Watts[0m
  - Power Supply State      : [32mAC Connected (Line Power / Charging)[0m[2m [USB-PD Input: 0.0W (C [PD] PD_PPS)][0m
  - Battery Capacity        : [1m56%[0m [Normal] ([1m1.0h to limit[0m) | Health: 94.2% (108 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 11.912 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 23.82 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   8.16 W ( 41.0%) [2mTemp: 68°C, 2163 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m35.7%[0m, C1: 1.9%, C2: 21.0%, C3 (Deep Sleep): [1m[33m41.4%[0m
  * GPU Silicon (DRM)     :   5.46 W ( 27.4%) [2mBusy: 39%, 456 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  7.5%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.73 W (  3.6%) [2mNVMe: active (Read 0.1 MB/s, Write 31.2 MB/s)[0m
  * Mechanical Fan        :   4.08 W ( 20.5%) [2m5602 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mChatGPT[0m (PID: 2724838, [36mTier 3 (User App)[0m, 26 thr, Nice: 0)
     Drain: [1m[31m2.31 W[0m (11.6% of system, WDI: 34.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (18 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 282/s, RAM PSS: 40MB, Faults: 128 min/s 0 maj/s, Sockets: 18[0m
  2. [1mfpstudio-resear[0m (PID: 3474902, [36mTier 5 (Runaway)[0m, 4 thr, Nice: -4)
     Drain: [1m[31m1.74 W[0m (8.7% of system, WDI: 23.0) | Primary Domain: [35mGPU Silicon[0m
     Causation Mechanism: [1mAMDGPU GFX Engine (0MB VRAM, 18% Duty)[0m
     Physical Metrics   : [2mWakeups: 104/s, RAM PSS: 51MB, Faults: 171 min/s 0 maj/s, Sockets: 0[0m
  3. [1mChatGPT[0m (PID: 2724967, [36mTier 3 (User App)[0m, 23 thr, Nice: 0)
     Drain: [1m[33m1.35 W[0m (6.8% of system, WDI: 22.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 151/s, RAM PSS: 711MB, Faults: 1703 min/s 2 maj/s, Sockets: 14[0m
  4. [1mChatGPT[0m (PID: 2724773, [36mTier 3 (User App)[0m, 56 thr, Nice: 0)
     Drain: [1m[33m1.16 W[0m (5.8% of system, WDI: 20.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 249/s, RAM PSS: 181MB, Faults: 1814 min/s 0 maj/s, Sockets: 32[0m
  5. [1mclang++[0m (PID: 3463399, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[31m2.36 W[0m (11.8% of system, WDI: 20.2) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (597 ticks, 26% CPU)[0m
     Physical Metrics   : [2mWakeups: 1/s, RAM PSS: 391MB, Faults: 4 min/s 0 maj/s, Sockets: 0[0m
  6. [1mbun[0m (PID: 3454178, [36mTier 5 (Runaway)[0m, 15 thr, Nice: 16)
     Drain: [1m[33m1.17 W[0m (5.9% of system, WDI: 19.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (5 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 242/s, RAM PSS: 155MB, Faults: 6365 min/s 0 maj/s, Sockets: 5[0m
  7. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -12)
     Drain: [1m[33m0.61 W[0m (3.1% of system, WDI: 18.7) | Primary Domain: [35mCPU C-State Wakeup[0m
     Causation Mechanism: [1mC3 Sleep Breaker (340 wakeups/s)[0m
     Physical Metrics   : [2mWakeups: 340/s, RAM PSS: 54MB, Faults: 26 min/s 0 maj/s, Sockets: 0[0m
  8. [1mopencode[0m (PID: 3153420, [36mTier 1 (Compositor)[0m, 18 thr, Nice: -5)
     Drain: [1m[33m0.64 W[0m (3.2% of system, WDI: 11.6) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 147/s, RAM PSS: 192MB, Faults: 3 min/s 0 maj/s, Sockets: 6[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (2282 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             69.67 msec task-clock:u                                                          
         9,666,940      cycles:u                                                              
        10,330,551      instructions:u                                                        
           139,151      L1-dcache-load-misses:u                                               
             3,742      dTLB-load-misses:u                                                    
            96,873      branch-misses:u                                                       
               305      page-faults:u                                                         

       6.073675572 seconds time elapsed

       0.006053000 seconds user
       0.063572000 seconds sys
```
