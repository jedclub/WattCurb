...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 60.134 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=3, TSC=8146801528202)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.2684 us/op (455.4 cycles/op)
   * Battery physics calc   : 0.1111 us/op
   * Full-scope E2E pipeline: 0.5133 us/op (871.0 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.2133 us/op
   * Average CPU Cycles    : 361.9 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 1805us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0452 us/op
   * Average Cycles  : 76.7 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 840.72 us/op (1426535.94 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 24.23 us/op (41112.23 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 22.33 us/op (37891.88 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 3.73 ns/op (6.33 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 5.29 ns/op (8.97 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 2.16 ns/op (3.64 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 68.2 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=57996814 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 ...
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.0039 us/op
   * Average Cycles  : 6.6 cycles/op
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906920 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 15:53:12] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2906921 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0085 us/op
   * Average Cycles  : 14.4 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 28852.9 us
   * Average Latency : 14.4265 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 14.4265 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.7252 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 9.9749 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 5.8162 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1372.8164 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 1707 MHz
   - C-State POLL=29448768965us, C1=38882676277us, C2=407166455078us, C3=3968270988550us
   - GPU Power: 9.000000 W
   - GPU Busy: 22%
   - Fan RPM: 4782
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 933498406
 ...
 [ORACLE GATE] 100k stat parses completed in 24228 us (0.2423 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          2,649.13 msec task-clock:u                                                          
     4,314,064,050      cycles:u                                                                (28.60%)
     9,246,896,009      instructions:u                                                          (28.53%)
         8,860,327      cache-misses:u                                                          (28.49%)
        61,232,845      L1-dcache-load-misses:u                                                 (28.57%)
           506,164      dTLB-load-misses:u                                                      (28.57%)
     2,163,509,892      branches:u                                                              (28.71%)
        12,379,295      branch-misses:u                                                         (28.72%)

       2.775040795 seconds time elapsed

       2.176110000 seconds user
       0.432684000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6068 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m128.21 Joules[0m[2m | Monitored Processes: [0m[1m199[0m[2m | Wakeups: [0m[1m2069 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m21.13 Watts[0m
  - Power Supply State      : [32mAC Connected (Line Power / Charging)[0m[2m [USB-PD Input: 0.0W (C [PD] PD_PPS)][0m
  - Battery Capacity        : [1m77%[0m [Normal] ([1m0.5h to limit[0m) | Health: 94.2% (107 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 12.269 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 32.72 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   9.82 W ( 46.5%) [2mTemp: 70°C, 1626 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m14.6%[0m, C1: 3.1%, C2: 20.8%, C3 (Deep Sleep): [1m[33m61.4%[0m
  * GPU Silicon (DRM)     :   2.80 W ( 13.3%) [2mBusy: 21%, 479 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  7.0%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.50 W (  2.4%) [2mNVMe: active (Read 0.0 MB/s, Write 12.5 MB/s)[0m
  * Mechanical Fan        :   2.56 W ( 12.1%) [2m4782 RPM[0m
  * Uncore & Platform Loss:   3.95 W ( 18.7%) [2mASPM: default [performance] powersave[0m

[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mchrome[0m (PID: 2743115, [36mTier 3 (User App)[0m, 39 thr, Nice: -8)
     Drain: [1m[31m4.23 W[0m (20.0% of system, WDI: 48.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (28 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 245/s, RAM PSS: 85MB, Faults: 46 min/s 0 maj/s, Sockets: 28[0m
  2. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[33m1.10 W[0m (5.2% of system, WDI: 25.1) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (49 ticks, 6% CPU)[0m
     Physical Metrics   : [2mWakeups: 396/s, RAM PSS: 46MB, Faults: 93 min/s 0 maj/s, Sockets: 0[0m
  3. [1mchrome[0m (PID: 2743277, [36mTier 3 (User App)[0m, 26 thr, Nice: 0)
     Drain: [1m[31m2.20 W[0m (10.4% of system, WDI: 24.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 130/s, RAM PSS: 141MB, Faults: 86 min/s 0 maj/s, Sockets: 11[0m
  4. [1mchrome[0m (PID: 2743050, [36mTier 3 (User App)[0m, 42 thr, Nice: -8)
     Drain: [1m[33m1.31 W[0m (6.2% of system, WDI: 22.2) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 254/s, RAM PSS: 138MB, Faults: 25 min/s 0 maj/s, Sockets: 32[0m
  5. [1mbun[0m (PID: 2769319, [36mTier 5 (Runaway)[0m, 27 thr, Nice: 0)
     Drain: [1m[33m0.96 W[0m (4.5% of system, WDI: 16.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (9 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 188/s, RAM PSS: 210MB, Faults: 154 min/s 0 maj/s, Sockets: 9[0m
  6. [1mbun[0m (PID: 2858183, [36mTier 5 (Runaway)[0m, 14 thr, Nice: 0)
     Drain: [1m[33m1.05 W[0m (5.0% of system, WDI: 14.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (5 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 144/s, RAM PSS: 145MB, Faults: 4915 min/s 0 maj/s, Sockets: 5[0m
  7. [1mopencode[0m (PID: 2312346, [36mTier 1 (Compositor)[0m, 32 thr, Nice: -5)
     Drain: [1m[33m1.29 W[0m (6.1% of system, WDI: 14.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (16 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 84/s, RAM PSS: 985MB, Faults: 339 min/s 0 maj/s, Sockets: 16[0m
  8. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 110 thr, Nice: -6)
     Drain: [1m[33m1.04 W[0m (4.9% of system, WDI: 11.5) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 53/s, RAM PSS: 215MB, Faults: 15 min/s 0 maj/s, Sockets: 15[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (2069 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':
         ...
         6,345,306      cycles:u                                                                (40.34%)
         7,238,290      instructions:u                                                          (41.54%)
           151,678      L1-dcache-load-misses:u                                                 (40.08%)
             4,465      dTLB-load-misses:u                                                      (38.76%)
            82,895      branch-misses:u                                                         (39.27%)
               299      page-faults:u                                                         

       6.089539606 seconds time elapsed

       0.003916000 seconds user
       0.081420000 seconds sys
```
