...
| :--- | ---: | ---: |
| `output/wattcurb` (Daemon) | 373064 | 364 KB |
...
```text
[2026-09-22 14:38:27] [WATTCURB][ALERT:CONFLICT] power-profiles-daemon owns /sys/firmware/acpi/platform_profile; WattCurb will not write it. Run 'systemctl mask --now power-profiles-daemon' to give WattCurb full control.
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 40.676 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=8, TSC=539710600205)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1570 us/op (266.5 cycles/op)
   * Battery physics calc   : 0.0767 us/op
   * Full-scope E2E pipeline: 0.3120 us/op (529.5 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1433 us/op
   * Average CPU Cycles    : 243.2 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 22.89 ns/op
   * Average Cycles  : 38.8 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 [ORACLE GATE] Lazy FD Bypass Latency (50000 iters):
   * Average Latency : 0.48 ns/op
   * Average Cycles  : 0.8 cycles/op
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 1251us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0340 us/op
...
--- [REF-TEST-038] Desktop Tray Client Extreme Optimization Oracle Gate ---
 ...
 [ORACLE GATE] 500ms Hover Hysteresis Zero-Syscall Bypass Latency (100000 iters):
   * Average Latency : 34.82 ns/op
   * Average Cycles  : 59.1 cycles/op
 [ORACLE GATE] ToolTip Render Latency with BAR_LUT & Fast Sanitizer (20000 iters):
   * Average Latency : 0.041 us/op
   * Average Cycles  : 69.7 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 551.33 us/op (935496.26 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 14.53 us/op (24662.95 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 16.84 us/op (28567.11 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.60 ns/op (4.41 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 3.53 ns/op (5.98 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 1.45 ns/op (2.44 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 55.6 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=57548517 ticks)
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0077 us/op
   * Average Cycles  : 13.1 cycles/op
 [PASS] test_adaptive_c1_c2_cluster_dispersion (REF-TEST-048: C1=0..7, C2=8..15, Terminal Shield Active, 0.0 us/op)
--- [REF-TEST-049] K[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742619 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:38:28] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2742620 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
DE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   * Total Iterations: 2000
   * Total Time      : 26211.2 us
   * Average Latency : 13.1056 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 13.1056 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.6240 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 9.6207 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 4.9467 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1536.0312 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 1992 MHz
   - C-State POLL=29448768965us, C1=37747923654us, C2=394737030701us, C3=3933139478177us
   - GPU Power: 9.000000 W
   - GPU Busy: 76%
   - Fan RPM: 3463
   - Battery Discharging: true, AC Online: false
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 910889718
 ...
 [ORACLE GATE] 100k stat parses completed in 15922 us (0.1592 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,860.86 msec task-clock:u                                                          
     4,268,931,131      cycles:u                                                                (85.73%)
     9,204,420,717      instructions:u                                                          (85.67%)
         7,273,871      cache-misses:u                                                          (85.69%)
        62,107,734      L1-dcache-load-misses:u                                                 (85.60%)
           539,472      dTLB-load-misses:u                                                      (85.77%)
     2,171,998,802      branches:u                                                              (85.78%)
        12,625,111      branch-misses:u                                                         (85.80%)

       2.012139261 seconds time elapsed

       1.529117000 seconds user
       0.303822000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6039 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m181.36 Joules[0m[2m | Monitored Processes: [0m[1m168[0m[2m | Wakeups: [0m[1m1529 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[31m30.03 Watts[0m
  - Power Supply State      : [31mDischarging (On Battery)[0m
  - Battery Capacity        : [1m66%[0m [Normal] ([1m0.9h to empty[0m) | Health: 94.2% (107 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 10.927 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 28.05 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   4.12 W ( 13.7%) [2mTemp: 70°C, 2008 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m13.7%[0m, C1: 2.8%, C2: 17.2%, C3 (Deep Sleep): [1m[33m66.3%[0m
  * GPU Silicon (DRM)     :   9.62 W ( 32.1%) [2mBusy: 71%, 397 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  5.0%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.38 W (  1.3%) [2mNVMe: active (Read 2.3 MB/s, Write 0.0 MB/s)[0m
  * Mechanical Fan        :   1.00 W (  3.3%) [2m3463 RPM[0m
  * Uncore & Platform Loss:  13.41 W ( 44.7%) [2mASPM: default [performance] powersave[0m

[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mfpstudio-vkmatc[0m (PID: 2742624, [36mTier 5 (Runaway)[0m, 3 thr, Nice: 10)
     Drain: [1m[31m2.81 W[0m (9.4% of system, WDI: 34.1) | Primary Domain: [35mGPU Silicon[0m
     Causation Mechanism: [1mAMDGPU GFX Engine (0MB VRAM, 22% Duty)[0m
     Physical Metrics   : [2mWakeups: 52/s, RAM PSS: 98MB, Faults: 4393 min/s 0 maj/s, Sockets: 1[0m
  2. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[33m0.78 W[0m (2.6% of system, WDI: 24.8) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (5 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 359/s, RAM PSS: 55MB, Faults: 490 min/s 5 maj/s, Sockets: 0[0m
  3. [1mclang++[0m (PID: 2741823, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 16)
     Drain: [1m[31m2.12 W[0m (7.1% of system, WDI: 19.1) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (597 ticks, 58% CPU)[0m
     Physical Metrics   : [2mWakeups: 39/s, RAM PSS: 340MB, Faults: 920 min/s 0 maj/s, Sockets: 0[0m
  4. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 112 thr, Nice: -6)
     Drain: [1m[33m1.07 W[0m (3.6% of system, WDI: 16.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 70/s, RAM PSS: 205MB, Faults: 56 min/s 152 maj/s, Sockets: 15[0m
  5. [1mfpstudio-vkmatc[0m (PID: 2742657, [36mTier 5 (Runaway)[0m, 3 thr, Nice: 10)
     Drain: [1m[33m1.09 W[0m (3.6% of system, WDI: 13.1) | Primary Domain: [35mGPU Silicon[0m
     Causation Mechanism: [1mAMDGPU GFX Engine (0MB VRAM, 7% Duty)[0m
     Physical Metrics   : [2mWakeups: 30/s, RAM PSS: 98MB, Faults: 4394 min/s 0 maj/s, Sockets: 1[0m
  6. [1mclaude[0m (PID: 393928, [36mTier 3 (User App)[0m, 21 thr, Nice: 10)
     Drain: [1m[32m0.50 W[0m (1.7% of system, WDI: 12.1) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.53 MB/s)[0m
     Physical Metrics   : [2mWakeups: 91/s, RAM PSS: 364MB, Faults: 209 min/s 1 maj/s, Sockets: 4[0m
  7. [1mChatGPT[0m (PID: 2724773, [36mTier 5 (Runaway)[0m, 53 thr, Nice: -8)
     Drain: [1m[33m0.73 W[0m (2.4% of system, WDI: 11.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 16/s, RAM PSS: 243MB, Faults: 404 min/s 1 maj/s, Sockets: 32[0m
  8. [1mfoot[0m (PID: 1811, [36mTier 1 (Compositor)[0m, 5 thr, Nice: -5)
     Drain: [1m[32m0.45 W[0m (1.5% of system, WDI: 10.5) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 163/s, RAM PSS: 8MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [GPU Silicon] High GPU render engine activity detected (9.6 W). Closing hardware-accelerated background tabs/canvas will conserve battery.
  * [C-State Breaker] Wakeup frequency (1529 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
...
================================================================================================================
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':
             ...
             48.74 msec task-clock:u                                                          
         8,065,700      cycles:u                                                              
         9,129,082      instructions:u                                                        
            99,495      L1-dcache-load-misses:u                                               
             3,276      dTLB-load-misses:u                                                    
            81,539      branch-misses:u                                                       
               287      page-faults:u                                                         

       6.051898771 seconds time elapsed

       0.002918000 seconds user
       0.046128000 seconds sys
```
