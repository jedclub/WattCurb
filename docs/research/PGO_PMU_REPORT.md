...
| :--- | ---: | ---: |
| `output/wattcurb` (Daemon) | 365136 | 356 KB |
...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 50.524 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=6, TSC=29550886959400)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1223 us/op (207.5 cycles/op)
   * Battery physics calc   : 0.0534 us/op
   * Full-scope E2E pipeline: 0.2555 us/op (433.5 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1114 us/op
   * Average CPU Cycles    : 189.0 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 18.13 ns/op
   * Average Cycles  : 30.8 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0255 us/op
   * Average Cycles  : 43.3 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 444.73 us/op (754627.35 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 12.10 us/op (20535.09 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 12.25 us/op (20780.33 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 2.67 ns/op (4.53 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.97 ns/op (1.62 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 44.0 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=16385332 ticks)
...
--- [REF-TEST-071] Performance Swap Expansion Policy (REF-REQ-113) ---
 [PAS[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241997 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 14:18:29] [WATTCURB][MITIGATION] Mitigation Actuated: PID 241998 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 18200.1 us
   * Average Latency : 9.1000 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 9.1000 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.5065 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 8.1511 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 3.6915 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1568.3492 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 1676 MHz
   - C-State POLL=216159212us, C1=4317468058us, C2=290534049424us, C3=232605599526us
   - GPU Power: 9.000000 W
   - GPU Busy: 5%
   - Fan RPM: 4329
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1196993258
 ...
 [ORACLE GATE] 100k stat parses completed in 11134 us (0.1113 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,492.43 msec task-clock:u                                                          
     4,303,756,932      cycles:u                                                                (85.66%)
     9,187,697,922      instructions:u                                                          (85.87%)
         7,520,733      cache-misses:u                                                          (85.80%)
        63,929,677      L1-dcache-load-misses:u                                                 (85.69%)
           499,754      dTLB-load-misses:u                                                      (85.66%)
     2,178,182,782      branches:u                                                              (85.54%)
        11,824,419      branch-misses:u                                                         (85.88%)

       1.632899006 seconds time elapsed

       1.170318000 seconds user
       0.301267000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6029 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m131.94 Joules[0m[2m | Monitored Processes: [0m[1m124[0m[2m | Wakeups: [0m[1m906 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m21.88 Watts[0m[1m[32m [AC Hardware Pass-Through Active: Zero Battery Wear][0m
  ...
  - Voltage & Current Flow  : 11.852 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
...
[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  15.53 W ( 70.9%) [2mTemp: 65°C, 1628 MHz avg (schedutil)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m5.9%[0m, C1: 0.2%, C2: 3.9%, C3 (Deep Sleep): [1m[32m89.9%[0m
  * GPU Silicon (DRM)     :   0.98 W (  4.5%) [2mBusy: 5%, 340 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.90 W (  8.7%) [2mBrightness: 38%[0m
  * Storage / NVMe APST   :   0.37 W (  1.7%) [2mNVMe: active (Read 0.5 MB/s, Write 1.0 MB/s)[0m
  * Mechanical Fan        :   1.91 W (  8.7%) [2m4329 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1magy[0m (PID: 48310, [36mTier 1 (Compositor)[0m, 27 thr, Nice: -5)
     Drain: [1m[31m6.87 W[0m (31.4% of system, WDI: 58.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 27/s, RAM PSS: 324MB, Faults: 164 min/s 0 maj/s, Sockets: 11[0m
  2. [1mkwin_wayland[0m (PID: 1154, [36mTier 1 (Compositor)[0m, 35 thr, Nice: -10)
     Drain: [1m[31m2.48 W[0m (11.3% of system, WDI: 33.5) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (68 ticks, 15% CPU)[0m
     Physical Metrics   : [2mWakeups: 327/s, RAM PSS: 39MB, Faults: 4032 min/s 0 maj/s, Sockets: 0[0m
  3. [1mopencode[0m (PID: 175908, [36mTier 1 (Compositor)[0m, 17 thr, Nice: -5)
     Drain: [1m[31m1.76 W[0m (8.0% of system, WDI: 18.9) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (45 ticks, 10% CPU)[0m
     Physical Metrics   : [2mWakeups: 104/s, RAM PSS: 203MB, Faults: 8 min/s 0 maj/s, Sockets: 4[0m
  4. [1mfoot[0m (PID: 175420, [36mTier 1 (Compositor)[0m, 5 thr, Nice: -5)
     Drain: [1m[33m0.96 W[0m (4.4% of system, WDI: 18.9) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 266/s, RAM PSS: 8MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
  5. [1mplasmashell[0m (PID: 77134, [36mTier 2 (Shell)[0m, 55 thr, Nice: -6)
     Drain: [1m[33m1.14 W[0m (5.2% of system, WDI: 11.9) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (12 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 47/s, RAM PSS: 154MB, Faults: 5 min/s 0 maj/s, Sockets: 12[0m
  6. [1mopencode[0m (PID: 29322, [36mTier 1 (Compositor)[0m, 35 thr, Nice: -5)
     Drain: [1m[33m1.07 W[0m (4.9% of system, WDI: 9.9) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (7 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 16/s, RAM PSS: 236MB, Faults: 56 min/s 0 maj/s, Sockets: 7[0m
  7. [1mopencode[0m (PID: 175921, [36mTier 1 (Compositor)[0m, 25 thr, Nice: -5)
     Drain: [1m[33m0.89 W[0m (4.0% of system, WDI: 9.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (8 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 33/s, RAM PSS: 254MB, Faults: 19 min/s 0 maj/s, Sockets: 8[0m
  8. [1mchrome[0m (PID: 26961, [36mTier 3 (User App)[0m, 25 thr, Nice: 5)
     Drain: [1m[32m0.13 W[0m (0.6% of system, WDI: 5.2) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (3 w/s)[0m
     Physical Metrics   : [2mWakeups: 3/s, RAM PSS: 78MB, Faults: 166 min/s 1 maj/s, Sockets: 11[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (906 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             33.36 msec task-clock:u                                                          
         8,076,145      cycles:u                                                              
         6,499,778      instructions:u                                                        
            74,850      L1-dcache-load-misses:u                                               
             2,548      dTLB-load-misses:u                                                    
            54,913      branch-misses:u                                                       
               259      page-faults:u                                                         

       6.038888328 seconds time elapsed

       0.006126000 seconds user
       0.027530000 seconds sys
```
