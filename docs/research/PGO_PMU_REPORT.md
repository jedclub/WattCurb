...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 99.295 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=2, TSC=10430630661517)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.3119 us/op (529.2 cycles/op)
   * Battery physics calc   : 0.1258 us/op
   * Full-scope E2E pipeline: 0.5773 us/op (979.5 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.2734 us/op
   * Average CPU Cycles    : 464.0 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 [ORACLE GATE] Lazy FD Bypass Latency (50000 iters):
   * Average Latency : 0.30 ns/op
   * Average Cycles  : 0.5 cycles/op
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 3175us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0676 us/op
   * Average Cycles  : 114.7 cycles/op
...
--- [REF-TEST-038] Desktop Tray Client Extreme Optimization Oracle Gate ---
 ...
 [ORACLE GATE] 500ms Hover Hysteresis Zero-Syscall Bypass Latency (100000 iters):
   * Average Latency : 56.48 ns/op
   * Average Cycles  : 95.8 cycles/op
 [ORACLE GATE] ToolTip Render Latency with BAR_LUT & Fast Sanitizer (20000 iters):
   * Average Latency : 0.080 us/op
   * Average Cycles  : 135.8 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 1038.73 us/op (1762547.91 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 23.59 us/op (40029.99 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 21.22 us/op (36009.26 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 3.14 ns/op (5.32 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 3.96 ns/op (6.72 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.81 ns/op (1.34 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 86.0 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=58131370 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 ...
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.0053 us/op
   * Average Cycles  : 9.0 cycles/op
 [PASS] test_anti_starvation_and_greedy_capping (REF-[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967229 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2967231 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 16:15:38] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=24.71, profile=Performance; re-asserted ceiling and platform_profile (REF-REQ-112.10)
TEST-019: Cores 0..13 allowed, 2 reserved for audio/compositor, 0.0 us/op)
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0138 us/op
   * Average Cycles  : 23.5 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 39952.4 us
   * Average Latency : 19.9762 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 19.9762 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.7420 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 12.4512 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 7.6065 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1466.3319 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2722 MHz
   - C-State POLL=29448768965us, C1=39536169251us, C2=410011580060us, C3=3982333163182us
   - GPU Power: 15.000000 W
   - GPU Busy: 0%
   - Fan RPM: 4330
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 964645913
 ...
 [ORACLE GATE] 100k stat parses completed in 21517 us (0.2152 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          3,048.78 msec task-clock:u                                                          
     5,756,445,459      cycles:u                                                                (28.56%)
     9,248,374,306      instructions:u                                                          (28.53%)
        23,063,270      cache-misses:u                                                          (28.58%)
        76,280,582      L1-dcache-load-misses:u                                                 (28.52%)
           919,709      dTLB-load-misses:u                                                      (28.65%)
     2,172,141,573      branches:u                                                              (28.67%)
        14,581,634      branch-misses:u                                                         (28.65%)

       3.394932883 seconds time elapsed

       2.366950000 seconds user
       0.580349000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6086 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m121.12 Joules[0m[2m | Monitored Processes: [0m[1m207[0m[2m | Wakeups: [0m[1m4228 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m19.90 Watts[0m[1m[32m [AC Hardware Pass-Through Active: Zero Battery Wear][0m
  ...
  - Voltage & Current Flow  : 11.872 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
...
[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  14.20 W ( 71.4%) [2mTemp: 70°C, 2377 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m40.5%[0m, C1: 1.6%, C2: 13.3%, C3 (Deep Sleep): [1m[33m44.6%[0m
  * GPU Silicon (DRM)     :   0.05 W (  0.3%) [2mBusy: 0%, 456 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  7.5%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   1.05 W (  5.3%) [2mNVMe: active (Read 50.2 MB/s, Write 8.1 MB/s)[0m
  * Mechanical Fan        :   1.91 W (  9.6%) [2m4329 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 110 thr, Nice: -6)
     Drain: [1m[31m2.88 W[0m (14.5% of system, WDI: 109.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 1859/s, RAM PSS: 160MB, Faults: 35 min/s 912 maj/s, Sockets: 15[0m
  2. [1mclang++[0m (PID: 2966443, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m2.33 W[0m (11.7% of system, WDI: 59.9) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (460 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 919/s, RAM PSS: 1143MB, Faults: 4017 min/s 460 maj/s, Sockets: 0[0m
  3. [1mclang++[0m (PID: 2966854, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m3.23 W[0m (16.2% of system, WDI: 35.8) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (58 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 131/s, RAM PSS: 1065MB, Faults: 16615 min/s 58 maj/s, Sockets: 0[0m
  4. [1mclang++[0m (PID: 2967030, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m3.20 W[0m (16.1% of system, WDI: 35.0) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (57 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 118/s, RAM PSS: 894MB, Faults: 17778 min/s 57 maj/s, Sockets: 0[0m
  5. [1mninja[0m (PID: 2965192, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m2.96 W[0m (14.9% of system, WDI: 28.0) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (1 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 6/s, RAM PSS: 3MB, Faults: 0 min/s 1 maj/s, Sockets: 2[0m
  6. [1mbun[0m (PID: 2769319, [36mTier 5 (Runaway)[0m, 26 thr, Nice: 0)
     Drain: [1m[33m0.95 W[0m (4.8% of system, WDI: 26.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 351/s, RAM PSS: 34MB, Faults: 50 min/s 4 maj/s, Sockets: 6[0m
  7. [1mclang++[0m (PID: 2966856, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m2.00 W[0m (10.0% of system, WDI: 20.9) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (5 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 11/s, RAM PSS: 951MB, Faults: 10997 min/s 5 maj/s, Sockets: 0[0m
  8. [1mclang++[0m (PID: 2966840, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 0)
     Drain: [1m[31m1.93 W[0m (9.7% of system, WDI: 20.4) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (3 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 11/s, RAM PSS: 909MB, Faults: 11141 min/s 3 maj/s, Sockets: 0[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (4228 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

            102.02 msec task-clock:u                                                          
        11,197,212      cycles:u                                                                (39.90%)
         9,008,243      instructions:u                                                          (39.33%)
           198,238      L1-dcache-load-misses:u                                                 (37.87%)
             6,952      dTLB-load-misses:u                                                      (41.10%)
           105,650      branch-misses:u                                                         (41.80%)
               305      page-faults:u                                                         

       6.105822927 seconds time elapsed

       0.006816000 seconds user
       0.092347000 seconds sys
```
