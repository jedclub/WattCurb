...
| `output/wattcurb-dashboard` (Matrix Dashboard) | 257408 | 251 KB |
...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 49.573 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=8, TSC=35625548727817)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1433 us/op (243.2 cycles/op)
   * Battery physics calc   : 0.0582 us/op
   * Full-scope E2E pipeline: 0.2648 us/op (449.2 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1238 us/op
   * Average CPU Cycles    : 210.1 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 782us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0301 us/op
   * Average Cycles  : 51.0 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 527.02 us/op (894247.38 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 13.17 us/op (22343.41 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 13.31 us/op (22576.61 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 3.05 ns/op (5.17 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 47.3 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=19455122 ticks)
...
--- [REF-TEST-071] Performance Swap Expansion Policy (REF-REQ-113) ---
 [PAS[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504426 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 22:50:08] [WATTCURB][MITIGATION] Mitigation Actuated: PID 504427 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 20922.7 us
   * Average Latency : 10.4614 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 10.4614 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.5337 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 7.8753 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 3.8893 ms
 [PASS] test_ultra_endurance_extensions (REF-TEST-028: SMT, Bluetooth, Backlight Cap, DRRS, KWin Effects & Baloo verified)
 [ORACLE GATE] Platform Loss Decomposition (12.5W System -> 3.8W Plat): DRAM=1.3641W, [2026-09-26 22:50:08] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=6.32, profile=Performance; ceiling/profile were already at target, SMU re-apply refused (baseline not captured); SMU baseline STAPM 0 mW (REF-REQ-112.10, REF-REQ-115.2)
VRM=1.6864W, Wi-Fi=0.5247W, MB/IO=0.2249W (Invariant Sum=3.8000W)
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1554.2159 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2473 MHz
   - C-State POLL=234222572us, C1=7040652363us, C2=335412634374us, C3=608370320352us
   - GPU Power: 11.000000 W
   - GPU Busy: 5%
   - Fan RPM: 3131
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 2017204856
 ...
 [ORACLE GATE] 100k stat parses completed in 12722 us (0.1272 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,639.74 msec task-clock:u                                                          
     4,396,485,016      cycles:u                                                                (85.74%)
     9,409,738,072      instructions:u                                                          (85.64%)
         8,121,135      cache-misses:u                                                          (85.80%)
        63,728,079      L1-dcache-load-misses:u                                                 (85.58%)
           545,061      dTLB-load-misses:u                                                      (85.68%)
     2,214,935,799      branches:u                                                              (85.90%)
        13,841,067      branch-misses:u                                                         (85.72%)

       1.778592642 seconds time elapsed

       1.321300000 seconds user
       0.297474000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6026 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m101.55 Joules[0m[2m | Monitored Processes: [0m[1m140[0m[2m | Wakeups: [0m[1m1756 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m16.85 Watts[0m[1m[32m [AC Hardware Pass-Through Active: Zero Battery Wear][0m
  ...
  - Voltage & Current Flow  : 11.865 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
...
[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  11.84 W ( 70.3%) [2mTemp: 69°C, 1797 MHz avg (schedutil)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m8.5%[0m, C1: 0.2%, C2: 17.2%, C3 (Deep Sleep): [1m[32m74.1%[0m
  * GPU Silicon (DRM)     :   0.78 W (  4.6%) [2mBusy: 5%, 369 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.90 W ( 11.3%) [2mBrightness: 38%[0m
  * Storage / NVMe APST   :   0.37 W (  2.2%) [2mNVMe: active (Read 0.9 MB/s, Write 0.5 MB/s)[0m
  * Mechanical Fan        :   0.75 W (  4.5%) [2m3131 RPM[0m
  * Uncore & Platform Loss:   1.20 W (  7.1%) [2mASPM: [default] performance powersave[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1magy[0m (PID: 48310, [36mTier 1 (Compositor)[0m, 27 thr, Nice: -5)
     Drain: [1m[31m4.29 W[0m (25.4% of system, WDI: 36.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 16/s, RAM PSS: 408MB, Faults: 164 min/s 0 maj/s, Sockets: 11[0m
  2. [1mkwin_wayland[0m (PID: 1154, [36mTier 1 (Compositor)[0m, 36 thr, Nice: -10)
     Drain: [1m[31m2.06 W[0m (12.2% of system, WDI: 33.0) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (79 ticks, 16% CPU)[0m
     Physical Metrics   : [2mWakeups: 406/s, RAM PSS: 48MB, Faults: 6444 min/s 0 maj/s, Sockets: 0[0m
  3. [1mopencode[0m (PID: 29322, [36mTier 1 (Compositor)[0m, 36 thr, Nice: -5)
     Drain: [1m[31m2.02 W[0m (12.0% of system, WDI: 23.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 52/s, RAM PSS: 291MB, Faults: 1368 min/s 53 maj/s, Sockets: 11[0m
  4. [1mopencode[0m (PID: 29313, [36mTier 1 (Compositor)[0m, 20 thr, Nice: -5)
     Drain: [1m[33m1.43 W[0m (8.5% of system, WDI: 21.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 141/s, RAM PSS: 201MB, Faults: 49 min/s 5 maj/s, Sockets: 6[0m
  5. [1mfoot[0m (PID: 175420, [36mTier 1 (Compositor)[0m, 5 thr, Nice: -5)
     Drain: [1m[33m0.84 W[0m (5.0% of system, WDI: 18.9) | Primary Domain: [35mCPU C-State Wakeup[0m
     Causation Mechanism: [1mC3 Sleep Breaker (291 wakeups/s)[0m
     Physical Metrics   : [2mWakeups: 291/s, RAM PSS: 12MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
  6. [1mfoot[0m (PID: 21961, [36mTier 1 (Compositor)[0m, 5 thr, Nice: -5)
     Drain: [1m[33m0.76 W[0m (4.5% of system, WDI: 16.1) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 237/s, RAM PSS: 7MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
  7. [1mopencode[0m (PID: 175908, [36mTier 1 (Compositor)[0m, 18 thr, Nice: -5)
     Drain: [1m[33m1.24 W[0m (7.4% of system, WDI: 16.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (5 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 137/s, RAM PSS: 257MB, Faults: 11 min/s 0 maj/s, Sockets: 5[0m
  8. [1mplasmashell[0m (PID: 77134, [36mTier 2 (Shell)[0m, 55 thr, Nice: -6)
     Drain: [1m[33m1.03 W[0m (6.1% of system, WDI: 10.9) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (12 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 47/s, RAM PSS: 160MB, Faults: 14 min/s 0 maj/s, Sockets: 12[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (1756 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             35.78 msec task-clock:u                                                          
         7,881,253      cycles:u                                                              
         7,311,746      instructions:u                                                        
            79,116      L1-dcache-load-misses:u                                               
             2,854      dTLB-load-misses:u                                                    
            62,083      branch-misses:u                                                       
               296      page-faults:u                                                         

       6.040877953 seconds time elapsed

       0.002017000 seconds user
       0.034094000 seconds sys
```
