...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 32.882 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=0, TSC=859080063528)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1276 us/op (216.6 cycles/op)
   * Battery physics calc   : 0.0593 us/op
   * Full-scope E2E pipeline: 0.2605 us/op (442.1 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1245 us/op
   * Average CPU Cycles    : 211.3 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 19.11 ns/op
   * Average Cycles  : 32.4 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 964us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0278 us/op
   * Average Cycles  : 47.2 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 434.70 us/op (737600.59 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 12.00 us/op (20354.79 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 11.95 us/op (20269.93 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 1.90 ns/op (3.22 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 2.61 ns/op (4.43 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.49 ns/op (0.83 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 44.4 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=59788098 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 ...
 [PASS] test_multilingual_l10n_and_auto_system_locale (REF-TEST-041: 13 languages, 46 st[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342234 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 20:51:44] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3342235 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
rings, POSIX auto-detect verified)
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.0024 us/op
   * Average Cycles  : 4.0 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 18134.2 us
   * Average Latency : 9.0671 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 9.0671 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.5173 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 7.9746 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 4.1860 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1462.9404 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2464 MHz
   - C-State POLL=29448768965us, C1=43547179389us, C2=451406162751us, C3=4143692538884us
   - GPU Power: 29.000000 W
   - GPU Busy: 14%
   - Fan RPM: 5405
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1442723945
 ...
 [ORACLE GATE] 100k stat parses completed in 11705 us (0.1171 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,433.11 msec task-clock:u                                                          
     4,341,487,720      cycles:u                                                                (85.50%)
     9,241,505,925      instructions:u                                                          (85.71%)
         7,682,131      cache-misses:u                                                          (85.88%)
        62,417,494      L1-dcache-load-misses:u                                                 (85.69%)
           544,817      dTLB-load-misses:u                                                      (85.73%)
     2,183,919,061      branches:u                                                              (85.76%)
        12,418,488      branch-misses:u                                                         (85.76%)

       1.577847125 seconds time elapsed

       1.159506000 seconds user
       0.256275000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6035 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m108.42 Joules[0m[2m | Monitored Processes: [0m[1m178[0m[2m | Wakeups: [0m[1m1371 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m19.90 Watts[0m
  - Power Supply State      : [32mAC Connected (Line Power / Charging)[0m[2m [USB-PD Input: 0.0W (C [PD] PD_PPS)][0m
  - Battery Capacity        : [1m61%[0m [Normal] ([1m0.9h to limit[0m) | Health: 94.2% (108 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 12.032 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 25.97 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  12.21 W ( 61.4%) [2mTemp: 71°C, 2123 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m5.9%[0m, C1: 0.8%, C2: 18.6%, C3 (Deep Sleep): [1m[32m74.7%[0m
  * GPU Silicon (DRM)     :   2.16 W ( 10.9%) [2mBusy: 14%, 457 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  7.5%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.36 W (  1.8%) [2mNVMe: active (Read 0.1 MB/s, Write 0.9 MB/s)[0m
  * Mechanical Fan        :   3.67 W ( 18.5%) [2m5405 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mChatGPT[0m (PID: 2724967, [36mTier 3 (User App)[0m, 23 thr, Nice: 0)
     Drain: [1m[31m3.67 W[0m (18.4% of system, WDI: 37.5) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 150/s, RAM PSS: 768MB, Faults: 1060 min/s 0 maj/s, Sockets: 14[0m
  2. [1mChatGPT[0m (PID: 2724838, [36mTier 3 (User App)[0m, 26 thr, Nice: -8)
     Drain: [1m[31m3.17 W[0m (15.9% of system, WDI: 37.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (18 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 229/s, RAM PSS: 52MB, Faults: 160 min/s 0 maj/s, Sockets: 18[0m
  3. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[31m1.75 W[0m (8.8% of system, WDI: 29.2) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (47 ticks, 10% CPU)[0m
     Physical Metrics   : [2mWakeups: 360/s, RAM PSS: 88MB, Faults: 26 min/s 0 maj/s, Sockets: 0[0m
  4. [1mChatGPT[0m (PID: 2724773, [36mTier 3 (User App)[0m, 56 thr, Nice: -8)
     Drain: [1m[31m1.85 W[0m (9.3% of system, WDI: 27.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 263/s, RAM PSS: 199MB, Faults: 1803 min/s 0 maj/s, Sockets: 32[0m
  5. [1mopencode[0m (PID: 3153420, [36mTier 1 (Compositor)[0m, 17 thr, Nice: -5)
     Drain: [1m[33m1.47 W[0m (7.4% of system, WDI: 18.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 139/s, RAM PSS: 190MB, Faults: 1 min/s 0 maj/s, Sockets: 6[0m
  6. [1mcodex[0m (PID: 2724987, [36mTier 3 (User App)[0m, 39 thr, Nice: -8)
     Drain: [1m[33m1.13 W[0m (5.7% of system, WDI: 13.5) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (2 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 0/s, RAM PSS: 312MB, Faults: 1939 min/s 2 maj/s, Sockets: 27[0m
  7. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 110 thr, Nice: -6)
     Drain: [1m[33m1.17 W[0m (5.9% of system, WDI: 12.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 48/s, RAM PSS: 250MB, Faults: 0 min/s 0 maj/s, Sockets: 15[0m
  8. [1mchrome[0m (PID: 3285074, [36mTier 3 (User App)[0m, 28 thr, Nice: 0)
     Drain: [1m[33m0.92 W[0m (4.6% of system, WDI: 9.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 21/s, RAM PSS: 346MB, Faults: 42 min/s 0 maj/s, Sockets: 11[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (1371 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             42.92 msec task-clock:u                                                          
         8,533,522      cycles:u                                                              
         9,007,994      instructions:u                                                        
           101,132      L1-dcache-load-misses:u                                               
             3,220      dTLB-load-misses:u                                                    
            83,390      branch-misses:u                                                       
               285      page-faults:u                                                         

       6.047325235 seconds time elapsed

       0.003938000 seconds user
       0.039094000 seconds sys
```
