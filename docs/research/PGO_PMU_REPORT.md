...
| :--- | ---: | ---: |
| `output/wattcurb` (Daemon) | 369296 | 360 KB |
...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 27.792 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=8, TSC=3380953299909)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1439 us/op (244.2 cycles/op)
   * Battery physics calc   : 0.0606 us/op
   * Full-scope E2E pipeline: 0.2630 us/op (446.3 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1299 us/op
   * Average CPU Cycles    : 220.3 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 20.93 ns/op
   * Average Cycles  : 35.5 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 770us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0304 us/op
   * Average Cycles  : 51.6 cycles/op
...
--- [REF-TEST-038] Desktop Tray Client Extreme Optimization Oracle Gate ---
 ...
 [ORACLE GATE] 500ms Hover Hysteresis Zero-Syscall Bypass Latency (100000 iters):
   * Average Latency : 28.36 ns/op
   * Average Cycles  : 48.1 cycles/op
 [ORACLE GATE] ToolTip Render Latency with BAR_LUT & Fast Sanitizer (20000 iters):
   * Average Latency : 0.037 us/op
   * Average Cycles  : 62.4 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 482.79 us/op (819206.22 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 13.05 us/op (22142.33 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 12.44 us/op (21110.01 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.03 ns/op (3.45 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 2.62 ns/op (4.44 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.59 ns/op (0.97 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 46.1 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=17554806 ticks)
...
--- [REF-TEST-071] Performance Swap Expansion Policy (REF-REQ-113) ---
 [PAS[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370882 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][MITIGATION] Mitigation Actuated: PID 370883 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 17:33:24] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=6.68, profile=Performance; ceiling/profile were already at target, SMU re-apply refused (baseline not captured); SMU baseline STAPM 0 mW (REF-REQ-112.10, REF-REQ-115.2)
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 21911.7 us
   * Average Latency : 10.9558 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 10.9558 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.5347 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 8.3923 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 4.0773 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1295.6310 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2069 MHz
   - C-State POLL=222373076us, C1=4973441870us, C2=298042815603us, C3=386524636313us
   - GPU Power: 9.000000 W
   - GPU Busy: 1%
   - Fan RPM: 3117
   - Battery Discharging: true, AC Online: false
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1335225847
 ...
 [ORACLE GATE] 100k stat parses completed in 12549 us (0.1255 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,620.26 msec task-clock:u                                                          
     4,348,942,531      cycles:u                                                                (85.34%)
     9,192,364,807      instructions:u                                                          (85.79%)
         8,872,395      cache-misses:u                                                          (85.84%)
        61,971,795      L1-dcache-load-misses:u                                                 (85.57%)
           541,548      dTLB-load-misses:u                                                      (85.86%)
     2,173,972,074      branches:u                                                              (85.81%)
        11,843,856      branch-misses:u                                                         (85.87%)

       1.769228928 seconds time elapsed

       1.266964000 seconds user
       0.327518000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6031 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m170.54 Joules[0m[2m | Monitored Processes: [0m[1m133[0m[2m | Wakeups: [0m[1m1461 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[31m28.27 Watts[0m
  - Power Supply State      : [31mDischarging (On Battery)[0m
  - Battery Capacity        : [1m60%[0m [Normal] ([1m0.9h to empty[0m) | Health: 94.2% (112 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 10.825 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 25.49 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  17.67 W ( 62.5%) [2mTemp: 69°C, 1896 MHz avg (schedutil)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m12.3%[0m, C1: 0.2%, C2: 7.6%, C3 (Deep Sleep): [1m[32m79.9%[0m
  * GPU Silicon (DRM)     :   0.33 W (  1.2%) [2mBusy: 1%, 344 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.90 W (  6.7%) [2mBrightness: 38%[0m
  * Storage / NVMe APST   :   0.39 W (  1.4%) [2mNVMe: active (Read 2.1 MB/s, Write 0.8 MB/s)[0m
  * Mechanical Fan        :   0.74 W (  2.6%) [2m3117 RPM[0m
  * Uncore & Platform Loss:   7.24 W ( 25.6%) [2mASPM: [default] performance powersave[0m

[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1magy[0m (PID: 48310, [36mTier 1 (Compositor)[0m, 27 thr, Nice: -5)
     Drain: [1m[31m3.85 W[0m (13.6% of system, WDI: 36.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (12 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 13/s, RAM PSS: 273MB, Faults: 833 min/s 52 maj/s, Sockets: 12[0m
  2. [1mopencode[0m (PID: 29313, [36mTier 1 (Compositor)[0m, 18 thr, Nice: -5)
     Drain: [1m[31m1.96 W[0m (6.9% of system, WDI: 25.8) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 138/s, RAM PSS: 180MB, Faults: 568 min/s 74 maj/s, Sockets: 6[0m
  3. [1mkwin_wayland[0m (PID: 1154, [36mTier 1 (Compositor)[0m, 35 thr, Nice: -12)
     Drain: [1m[33m1.30 W[0m (4.6% of system, WDI: 24.9) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (57 ticks, 6% CPU)[0m
     Physical Metrics   : [2mWakeups: 357/s, RAM PSS: 16MB, Faults: 321 min/s 0 maj/s, Sockets: 0[0m
  4. [1mcpuphase_regsum[0m (PID: 370881, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[31m2.97 W[0m (10.5% of system, WDI: 24.0) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (199 ticks, 21% CPU)[0m
     Physical Metrics   : [2mWakeups: 1/s, RAM PSS: 332MB, Faults: 0 min/s 0 maj/s, Sockets: 0[0m
  5. [1mcpuphase_final[0m (PID: 370899, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[31m2.90 W[0m (10.3% of system, WDI: 23.5) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (191 ticks, 20% CPU)[0m
     Physical Metrics   : [2mWakeups: 2/s, RAM PSS: 334MB, Faults: 2311 min/s 0 maj/s, Sockets: 0[0m
  6. [1mopencode[0m (PID: 175921, [36mTier 1 (Compositor)[0m, 24 thr, Nice: -5)
     Drain: [1m[33m0.95 W[0m (3.4% of system, WDI: 18.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (7 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 163/s, RAM PSS: 58MB, Faults: 6 min/s 76 maj/s, Sockets: 7[0m
  7. [1mclaude[0m (PID: 69430, [36mTier 3 (User App)[0m, 27 thr, Nice: -4)
     Drain: [1m[33m1.12 W[0m (4.0% of system, WDI: 17.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (8 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 102/s, RAM PSS: 211MB, Faults: 100 min/s 76 maj/s, Sockets: 8[0m
  8. [1mfoot[0m (PID: 21961, [36mTier 1 (Compositor)[0m, 5 thr, Nice: -5)
     Drain: [1m[33m0.74 W[0m (2.6% of system, WDI: 16.3) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 246/s, RAM PSS: 4MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (1461 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
...
================================================================================================================
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':
             ...
             45.70 msec task-clock:u                                                          
         7,426,781      cycles:u                                                              
         7,253,764      instructions:u                                                        
            89,297      L1-dcache-load-misses:u                                               
             3,091      dTLB-load-misses:u                                                    
            62,940      branch-misses:u                                                       
               293      page-faults:u                                                         

       6.051279733 seconds time elapsed

       0.005853000 seconds user
