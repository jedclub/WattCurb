...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 91.151 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=6, TSC=9236393598500)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.2034 us/op (345.1 cycles/op)
   * Battery physics calc   : 0.1031 us/op
   * Full-scope E2E pipeline: 0.4030 us/op (683.7 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1618 us/op
   * Average CPU Cycles    : 274.5 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 26.47 ns/op
   * Average Cycles  : 44.9 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 3146us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0465 us/op
   * Average Cycles  : 78.9 cycles/op
...
--- [REF-TEST-038] Desktop Tray Client Extreme Optimization Oracle Gate ---
 ...
 [ORACLE GATE] 500ms Hover Hysteresis Zero-Syscall Bypass Latency (100000 iters):
   * Average Latency : 35.48 ns/op
   * Average Cycles  : 60.2 cycles/op
 [ORACLE GATE] ToolTip Render Latency with BAR_LUT & Fast Sanitizer (20000 iters):
   * Average Latency : 0.049 us/op
   * Average Cycles  : 83.9 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 711.84 us/op (1207852.29 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 18.80 us/op (31897.31 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 18.36 us/op (31149.06 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.81 ns/op (4.76 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 4.35 ns/op (7.38 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.82 ns/op (1.38 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 70.9 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=60281797 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 [ORACLE GATE] O(1) L10n Translation Latency (100000 iters):
   * Average Latency : 4.9 ns/op
 [PASS] test_multilingual_l10n_and_auto_system_locale (REF-TEST-041: 13 languages,[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459276 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3459277 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 22:14:02] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=16.61, profile=Performance; re-asserted ceiling and platform_profile (REF-REQ-112.10)
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0093 us/op
   * Average Cycles  : 15.8 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 32591.5 us
   * Average Latency : 16.2958 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 16.2958 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.7374 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 11.0526 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 6.6303 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1520.8522 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2261 MHz
   - C-State POLL=29448768965us, C1=44495876516us, C2=464523846943us, C3=4182403381896us
   - GPU Power: 11.000000 W
   - GPU Busy: 15%
   - Fan RPM: 5341
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1558359303
 ...
 [ORACLE GATE] 100k stat parses completed in 21362 us (0.2136 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          2,403.64 msec task-clock:u                                                          
     4,689,474,317      cycles:u                                                                (85.62%)
     9,232,195,627      instructions:u                                                          (85.77%)
        12,874,805      cache-misses:u                                                          (85.74%)
        69,871,541      L1-dcache-load-misses:u                                                 (85.80%)
           728,620      dTLB-load-misses:u                                                      (85.78%)
     2,177,269,646      branches:u                                                              (85.80%)
        13,426,440      branch-misses:u                                                         (85.54%)

       2.543407826 seconds time elapsed

       1.813826000 seconds user
       0.515729000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6065 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m114.45 Joules[0m[2m | Monitored Processes: [0m[1m230[0m[2m | Wakeups: [0m[1m2250 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m23.62 Watts[0m
  - Power Supply State      : [32mAC Connected (Line Power / Charging)[0m[2m [USB-PD Input: 0.0W (C [PD] PD_PPS)][0m
  - Battery Capacity        : [1m44%[0m [Normal] ([1m1.3h to limit[0m) | Health: 94.2% (108 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 11.712 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 18.78 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  15.12 W ( 64.0%) [2mTemp: 69°C, 2433 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m52.5%[0m, C1: 1.5%, C2: 22.3%, C3 (Deep Sleep): [1m[33m23.7%[0m
  * GPU Silicon (DRM)     :   2.64 W ( 11.2%) [2mBusy: 14%, 455 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  6.3%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.83 W (  3.5%) [2mNVMe: active (Read 2.9 MB/s, Write 37.4 MB/s)[0m
  * Mechanical Fan        :   3.55 W ( 15.0%) [2m5341 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mChatGPT[0m (PID: 2724967, [36mTier 3 (User App)[0m, 23 thr, Nice: 0)
     Drain: [1m[31m1.84 W[0m (7.8% of system, WDI: 26.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 162/s, RAM PSS: 735MB, Faults: 1273 min/s 90 maj/s, Sockets: 14[0m
  2. [1mChatGPT[0m (PID: 2724838, [36mTier 3 (User App)[0m, 26 thr, Nice: 0)
     Drain: [1m[33m1.48 W[0m (6.2% of system, WDI: 23.2) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (18 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 237/s, RAM PSS: 40MB, Faults: 109 min/s 0 maj/s, Sockets: 18[0m
  3. [1mChatGPT[0m (PID: 2724773, [36mTier 3 (User App)[0m, 56 thr, Nice: 0)
     Drain: [1m[33m1.26 W[0m (5.3% of system, WDI: 22.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 263/s, RAM PSS: 173MB, Faults: 2781 min/s 0 maj/s, Sockets: 32[0m
  4. [1mclang++[0m (PID: 3459185, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[31m2.51 W[0m (10.6% of system, WDI: 21.7) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (595 ticks, 17% CPU)[0m
     Physical Metrics   : [2mWakeups: 16/s, RAM PSS: 509MB, Faults: 14467 min/s 0 maj/s, Sockets: 0[0m
  5. [1mclang++[0m (PID: 3459221, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[31m2.48 W[0m (10.5% of system, WDI: 20.9) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (593 ticks, 17% CPU)[0m
     Physical Metrics   : [2mWakeups: 2/s, RAM PSS: 474MB, Faults: 14916 min/s 0 maj/s, Sockets: 0[0m
  6. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -12)
     Drain: [1m[33m0.67 W[0m (2.8% of system, WDI: 19.7) | Primary Domain: [35mCPU C-State Wakeup[0m
     Causation Mechanism: [1mC3 Sleep Breaker (352 wakeups/s)[0m
     Physical Metrics   : [2mWakeups: 352/s, RAM PSS: 62MB, Faults: 26 min/s 0 maj/s, Sockets: 0[0m
  7. [1mbun[0m (PID: 3454178, [36mTier 5 (Runaway)[0m, 17 thr, Nice: 16)
     Drain: [1m[33m1.09 W[0m (4.6% of system, WDI: 18.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (5 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 214/s, RAM PSS: 145MB, Faults: 6420 min/s 0 maj/s, Sockets: 5[0m
  8. [1mld[0m (PID: 3459424, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -4)
     Drain: [1m[33m1.17 W[0m (4.9% of system, WDI: 14.8) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (1 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 27/s, RAM PSS: 189MB, Faults: 10595 min/s 1 maj/s, Sockets: 0[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (2250 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             84.23 msec task-clock:u                                                          
        12,490,244      cycles:u                                                              
        10,366,234      instructions:u                                                        
           199,883      L1-dcache-load-misses:u                                               
             4,054      dTLB-load-misses:u                                                    
           101,038      branch-misses:u                                                       
               313      page-faults:u                                                         

       6.088503169 seconds time elapsed

       0.005044000 seconds user
       0.078927000 seconds sys
```
