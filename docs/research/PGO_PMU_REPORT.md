...
| :--- | ---: | ---: |
| `output/wattcurb` (Daemon) | 401640 | 392 KB |
...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 80.781 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=10, TSC=14814630221282)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.9906 us/op (1680.9 cycles/op)
   * Battery physics calc   : 0.4171 us/op
   * Full-scope E2E pipeline: 1.6313 us/op (2768.0 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.3339 us/op
   * Average CPU Cycles    : 566.5 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 52.48 ns/op
   * Average Cycles  : 89.1 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 [ORACLE GATE] Lazy FD Bypass Latency (50000 iters):
   * Average Latency : 13.77 ns/op
   * Average Cycles  : 23.4 cycles/op
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 3488us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.1184 us/op
   * Average Cycles  : 200.9 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 1241.77 us/op (2107035.05 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 33.96 us/op (57626.41 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 35.44 us/op (60133.65 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 5.35 ns/op (9.07 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 7.47 ns/op (12.66 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 16.31 ns/op (27.63 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 117.0 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=60610542 ticks)
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verifica[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530975 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][MITIGATION] Mitigation Actuated: PID 3530976 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 23:08:51] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=15.28, profile=Performance; ceiling/profile were already at target, SMU re-apply refused (baseline not captured); SMU baseline STAPM 0 mW (REF-REQ-112.10, REF-REQ-115.2)
tion ---
 [ORACLE GATE] O(1) L10n Translation Latency (100000 iters):
   * Average Latency : 8.3 ns/op
 ...
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.1006 us/op
   * Average Cycles  : 170.8 cycles/op
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0974 us/op
   * Average Cycles  : 165.3 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 56105.7 us
   * Average Latency : 28.0528 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 28.0528 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 1.3200 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 20.1665 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 11.2441 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1817.3911 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   - CPU Temp: 46.125000 C
   - CPU Cores Online: 16, Avg Freq: 1491 MHz
   - C-State POLL=29448768965us, C1=44907705782us, C2=471365335393us, C3=4192805120115us
   - GPU Power: 4.000000 W
   - GPU Busy: 42%
   - Fan RPM: 5647
   - Battery Discharging: true, AC Online: false
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 1572435415
 ...
 [ORACLE GATE] 100k stat parses completed in 35016 us (0.3502 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          4,256.93 msec task-clock:u                                                          
     4,725,971,589      cycles:u                                                                (85.70%)
     9,646,895,413      instructions:u                                                          (85.76%)
         8,874,268      cache-misses:u                                                          (85.77%)
        60,921,407      L1-dcache-load-misses:u                                                 (85.65%)
           572,715      dTLB-load-misses:u                                                      (85.73%)
     2,275,694,901      branches:u                                                              (85.71%)
        12,624,925      branch-misses:u                                                         (85.70%)

       4.381307883 seconds time elapsed

       3.420963000 seconds user
       0.699116000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6088 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m87.76 Joules[0m[2m | Monitored Processes: [0m[1m190[0m[2m | Wakeups: [0m[1m1827 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m14.41 Watts[0m
  - Power Supply State      : [31mDischarging (On Battery)[0m
  - Battery Capacity        : [1m71%[0m [Normal] ([1m2.1h to empty[0m) | Health: 94.2% (108 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 11.350 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 30.44 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   4.22 W ( 29.3%) [2mTemp: 45°C, 1650 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m9.7%[0m, C1: 0.9%, C2: 22.6%, C3 (Deep Sleep): [1m[33m66.8%[0m
  * GPU Silicon (DRM)     :   1.53 W ( 10.6%) [2mBusy: 24%, 462 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   0.86 W (  6.0%) [2mBrightness: 3%[0m
  * Storage / NVMe APST   :   0.42 W (  2.9%) [2mNVMe: active (Read 0.1 MB/s, Write 5.5 MB/s)[0m
  * Mechanical Fan        :   4.18 W ( 29.0%) [2m5647 RPM[0m
  * Uncore & Platform Loss:   3.20 W ( 22.2%) [2mASPM: default [performance] powersave[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mChatGPT[0m (PID: 2724838, [36mTier 3 (User App)[0m, 26 thr, Nice: 0)
     Drain: [1m[31m2.08 W[0m (14.4% of system, WDI: 29.2) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (18 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 245/s, RAM PSS: 40MB, Faults: 187 min/s 0 maj/s, Sockets: 18[0m
  2. [1mChatGPT[0m (PID: 2724967, [36mTier 3 (User App)[0m, 23 thr, Nice: 0)
     Drain: [1m[31m2.04 W[0m (14.2% of system, WDI: 25.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 162/s, RAM PSS: 719MB, Faults: 1093 min/s 0 maj/s, Sockets: 14[0m
  3. [1mChatGPT[0m (PID: 2724773, [36mTier 3 (User App)[0m, 56 thr, Nice: 0)
     Drain: [1m[33m1.30 W[0m (9.0% of system, WDI: 22.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 265/s, RAM PSS: 189MB, Faults: 83 min/s 0 maj/s, Sockets: 32[0m
  4. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[33m0.88 W[0m (6.1% of system, WDI: 21.7) | Primary Domain: [35mCPU C-State Wakeup[0m
     Causation Mechanism: [1mC3 Sleep Breaker (351 wakeups/s)[0m
     Physical Metrics   : [2mWakeups: 351/s, RAM PSS: 58MB, Faults: 0 min/s 0 maj/s, Sockets: 0[0m
  5. [1mopencode[0m (PID: 3515949, [36mTier 1 (Compositor)[0m, 17 thr, Nice: -5)
     Drain: [1m[33m0.84 W[0m (5.8% of system, WDI: 13.8) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 156/s, RAM PSS: 182MB, Faults: 59 min/s 0 maj/s, Sockets: 4[0m
  6. [1mopencode[0m (PID: 3153420, [36mTier 1 (Compositor)[0m, 19 thr, Nice: -5)
     Drain: [1m[33m0.87 W[0m (6.0% of system, WDI: 13.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (6 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 139/s, RAM PSS: 198MB, Faults: 24 min/s 0 maj/s, Sockets: 6[0m
  7. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 110 thr, Nice: -6)
     Drain: [1m[33m0.82 W[0m (5.7% of system, WDI: 9.6) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 46/s, RAM PSS: 217MB, Faults: 28 min/s 0 maj/s, Sockets: 15[0m
  8. [1mclaude[0m (PID: 393928, [36mTier 3 (User App)[0m, 21 thr, Nice: 10)
     Drain: [1m[33m0.61 W[0m (4.2% of system, WDI: 8.5) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (73 w/s)[0m
     Physical Metrics   : [2mWakeups: 73/s, RAM PSS: 383MB, Faults: 246 min/s 0 maj/s, Sockets: 5[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (1827 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
...
================================================================================================================
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':
            ...
            106.37 msec task-clock:u                                                          
         8,721,881      cycles:u                                                              
         9,757,329      instructions:u                                                        
           114,585      L1-dcache-load-misses:u                                               
             3,553      dTLB-load-misses:u                                                    
            91,494      branch-misses:u                                                       
               294      page-faults:u                                                         

       6.111382665 seconds time elapsed

       0.007863000 seconds user
       0.098032000 seconds sys
```
