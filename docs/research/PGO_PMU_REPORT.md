...
| :--- | ---: | ---: |
| `output/wattcurb` (Daemon) | 373096 | 364 KB |
...
```text
[2026-09-22 14:57:43] [WATTCURB][ALERT:CONFLICT] power-profiles-daemon owns /sys/firmware/acpi/platform_profile; WattCurb will not write it. Run 'systemctl mask --now power-profiles-daemon' to give WattCurb full control.
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 36.291 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=8, TSC=2502767768429)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1350 us/op (229.1 cycles/op)
   * Battery physics calc   : 0.0588 us/op
   * Full-scope E2E pipeline: 0.2796 us/op (474.5 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1308 us/op
   * Average CPU Cycles    : 222.0 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 20.27 ns/op
   * Average Cycles  : 34.4 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 897us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0274 us/op
   * Average Cycles  : 46.4 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 471.38 us/op (799989.77 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 12.16 us/op (20634.40 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 12.19 us/op (20687.28 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.25 ns/op (3.81 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 2.69 ns/op (4.57 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.99 ns/op (1.67 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 45.7 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=57664194 ticks)
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORAC[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756264 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 14:57:45] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2756265 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
LE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0058 us/op
   * Average Cycles  : 9.8 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 18192.1 us
   * Average Latency : 9.0960 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 9.0960 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.4922 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 8.1624 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 5.4838 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1553.3661 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 2024 MHz
   - C-State POLL=29448768965us, C1=38009325462us, C2=398372880864us, C3=3943275752018us
   - GPU Power: 15.000000 W
   - GPU Busy: 0%
   - Fan RPM: 4339
   - Battery Discharging: true, AC Online: false
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 918388146
 ...
 [ORACLE GATE] 100k stat parses completed in 11680 us (0.1168 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,473.96 msec task-clock:u                                                          
     4,260,689,010      cycles:u                                                                (85.62%)
     9,246,294,254      instructions:u                                                          (85.71%)
         7,274,375      cache-misses:u                                                          (85.63%)
        58,944,102      L1-dcache-load-misses:u                                                 (85.70%)
           480,586      dTLB-load-misses:u                                                      (85.82%)
     2,180,251,245      branches:u                                                              (85.70%)
        11,827,086      branch-misses:u                                                         (85.86%)

       1.613396501 seconds time elapsed

       1.186025000 seconds user
       0.272085000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6042 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m133.16 Joules[0m[2m | Monitored Processes: [0m[1m182[0m[2m | Wakeups: [0m[1m624 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m22.04 Watts[0m
  - Power Supply State      : [31mDischarging (On Battery)[0m
  - Battery Capacity        : [1m49%[0m [Normal] ([1m0.9h to empty[0m) | Health: 94.2% (107 cycles)
  ...
  - Energy & Degradation    : 20.70 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   7.58 W ( 34.4%) [2mTemp: 65°C, 1855 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m6.1%[0m, C1: 1.7%, C2: 8.5%, C3 (Deep Sleep): [1m[32m83.6%[0m
  * GPU Silicon (DRM)     :   0.05 W (  0.2%) [2mBusy: 0%, 448 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.25 W (  5.7%) [2mBrightness: 18%[0m
  * Storage / NVMe APST   :   0.44 W (  2.0%) [2mNVMe: active (Read 7.9 MB/s, Write 0.0 MB/s)[0m
  * Mechanical Fan        :   1.92 W (  8.7%) [2m4339 RPM[0m
  * Uncore & Platform Loss:  10.80 W ( 49.0%) [2mASPM: default [performance] powersave[0m

[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mkscreenlocker_g[0m (PID: 2756271, [36mTier 5 (Runaway)[0m, 31 thr, Nice: 0)
     Drain: [1m[31m3.40 W[0m (15.4% of system, WDI: 37.8) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (26 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 133/s, RAM PSS: 121MB, Faults: 8086 min/s 26 maj/s, Sockets: 0[0m
  2. [1mplasmashell[0m (PID: 1262, [36mTier 2 (Shell)[0m, 110 thr, Nice: -6)
     Drain: [1m[31m1.56 W[0m (7.1% of system, WDI: 19.6) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (15 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 52/s, RAM PSS: 211MB, Faults: 0 min/s 9 maj/s, Sockets: 15[0m
  3. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[33m0.93 W[0m (4.2% of system, WDI: 15.9) | Primary Domain: [35mNVMe Storage / MajFlt[0m
     Causation Mechanism: [1mMajor Page Faults (36 flt/s, NVMe Active)[0m
     Physical Metrics   : [2mWakeups: 106/s, RAM PSS: 52MB, Faults: 272 min/s 36 maj/s, Sockets: 0[0m
  4. [1mChatGPT[0m (PID: 2724773, [36mTier 5 (Runaway)[0m, 53 thr, Nice: -8)
     Drain: [1m[33m1.05 W[0m (4.8% of system, WDI: 14.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 12/s, RAM PSS: 200MB, Faults: 661 min/s 5 maj/s, Sockets: 32[0m
  5. [1mclaude[0m (PID: 2699145, [36mTier 3 (User App)[0m, 22 thr, Nice: -4)
     Drain: [1m[33m1.13 W[0m (5.1% of system, WDI: 13.0) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (41 ticks, 11% CPU)[0m
     Physical Metrics   : [2mWakeups: 78/s, RAM PSS: 292MB, Faults: 70 min/s 0 maj/s, Sockets: 5[0m
  6. [1mdbus-broker[0m (PID: 1103, [36mTier 0 (Immune)[0m, 1 thr, Nice: 10)
     Drain: [1m[33m0.74 W[0m (3.4% of system, WDI: 9.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (63 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 47/s, RAM PSS: 2MB, Faults: 0 min/s 0 maj/s, Sockets: 63[0m
  7. [1mopencode[0m (PID: 2312346, [36mTier 1 (Compositor)[0m, 32 thr, Nice: -5)
     Drain: [1m[33m0.80 W[0m (3.6% of system, WDI: 8.0) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 14/s, RAM PSS: 1009MB, Faults: 10 min/s 0 maj/s, Sockets: 14[0m
  8. [1mclaude[0m (PID: 393928, [36mTier 3 (User App)[0m, 19 thr, Nice: 10)
     Drain: [1m[33m0.56 W[0m (2.5% of system, WDI: 5.8) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (23 w/s)[0m
     Physical Metrics   : [2mWakeups: 23/s, RAM PSS: 317MB, Faults: 0 min/s 0 maj/s, Sockets: 3[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (624 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
...
================================================================================================================
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':
             ...
             54.20 msec task-clock:u                                                          
         8,459,088      cycles:u                                                              
         9,223,280      instructions:u                                                        
           100,090      L1-dcache-load-misses:u                                               
             3,163      dTLB-load-misses:u                                                    
            83,961      branch-misses:u                                                       
               293      page-faults:u                                                         

       6.057876225 seconds time elapsed

       0.003112000 seconds user
       0.051526000 seconds sys
```
