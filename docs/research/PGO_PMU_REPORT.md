...
```text
[2026-09-22 10:16:38] [WATTCURB][ALERT:CONFLICT] power-profiles-daemon owns /sys/firmware/acpi/platform_profile; WattCurb will not write it. Run 'systemctl mask --now power-profiles-daemon' to give WattCurb full control.
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 36.779 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=0, TSC=201650443702)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1500 us/op (254.5 cycles/op)
   * Battery physics calc   : 0.0613 us/op
   * Full-scope E2E pipeline: 0.2714 us/op (460.5 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   ...
   * Average CPU Cycles    : 243.1 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 21.50 ns/op
   * Average Cycles  : 36.5 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_window_aware_governor (Non-Halting Graceful Throttle, Always-Alive Invariant verified: 12us)
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 1534us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0322 us/op
   * Average Cycles  : 54.6 cycles/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 513.47 us/op (871252.50 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 13.59 us/op (23065.19 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 13.61 us/op (23088.99 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 2.37 ns/op (4.02 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 3.21 ns/op (5.44 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.66 ns/op (1.10 cycles/op)
...
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594203 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-22 10:16:40] [WATTCURB][MITIGATION] Mitigation Actuated: PID 2594204 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
   * Badge hue (R-G)           : -163.0 (green) -> 196.0 (red), source=font
 [ORACLE GATE] Procedural Icon Render (300 iters @48px):
   * Average Latency : 35.8 us/op
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 50.0 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=55977859 ticks)
...
--- [REF-TEST-048] Adaptive C1/C2 Dual-Cluster Spatial Load Dispersion & Terminal Shield Verification ---
 [ORACLE GATE] Adaptive C1/C2 Cluster Benchmark (50000 iters):
   * Average Latency : 0.0076 us/op
   * Average Cycles  : 12.9 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 21906.9 us
   * Average Latency : 10.9534 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 10.9534 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.5495 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 8.6610 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 4.9028 ms
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1484.4706 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   - CPU Temp: 69.875000 C
   - CPU Cores Online: 16, Avg Freq: 2537 MHz
   - C-State POLL=29448768965us, C1=33277176613us, C2=373632283828us, C3=3743303363271us
   - GPU Power: 15.000000 W
   - GPU Busy: 28%
   - Fan RPM: 4310
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 578766500
 ...
 [ORACLE GATE] 100k stat parses completed in 13504 us (0.1350 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,667.55 msec task-clock:u                                                          
     4,399,598,786      cycles:u                                                                (84.84%)
     9,348,266,014      instructions:u                                                          (84.57%)
         9,774,927      cache-misses:u                                                          (84.59%)
        64,503,102      L1-dcache-load-misses:u                                                 (84.55%)
           540,547      dTLB-load-misses:u                                                      (84.83%)
     2,200,066,928      branches:u                                                              (84.69%)
        12,190,602      branch-misses:u                                                         (84.71%)

       1.805497216 seconds time elapsed

       1.329368000 seconds user
       0.312991000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6039 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m114.42 Joules[0m[2m | Monitored Processes: [0m[1m186[0m[2m | Wakeups: [0m[1m1839 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m18.95 Watts[0m
  - Power Supply State      : [32mAC Connected (Line Power / Charging)[0m[2m [USB-PD Input: 15.0W (C [PD] PD_PPS)][0m
  - Battery Capacity        : [1m55%[0m [Normal] ([1m1.0h to limit[0m) | Health: 94.2% (107 cycles)
  - Battery Hardware ID     : [1mSMP LNV-5B10W13895[0m (S/N: 3502) [Li-poly]
  - Voltage & Current Flow  : 11.954 V (Design Nominal: 11.10 V) | Flow: [0m0.000 A[0m
  - Energy & Degradation    : 23.67 Wh now / 42.65 Wh full (Design: 45.28 Wh) | [1m[32m5.8% wear (2.63 Wh lost)[0m

[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :   9.34 W ( 49.3%) [2mTemp: 69°C, 2435 MHz avg (performance)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m13.7%[0m, C1: 1.2%, C2: 21.6%, C3 (Deep Sleep): [1m[33m63.5%[0m
    └─ [2mDirect PMU Telemetry    : [0mIPC: [1m1.24[0m | Cycles: 3358499 | LLC Miss: 28511 | Branch Miss: 33139
       [2mPMU Power Proxy (REF-REQ-024): [0mEPI: [1m[36m11.6M[0m | EWR: [1m[31m55.6%[0m | Est. Power: [1m500.0 mW[0m
  * GPU Silicon (DRM)     :   3.66 W ( 19.3%) [2mBusy: 27%, 416 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.49 W (  7.9%) [2mBrightness: 25%[0m
  * Storage / NVMe APST   :   0.38 W (  2.0%) [2mNVMe: active (Read 0.6 MB/s, Write 1.6 MB/s)[0m
  * Mechanical Fan        :   1.89 W ( 10.0%) [2m4310 RPM[0m
  * Uncore & Platform Loss:   2.19 W ( 11.6%) [2mASPM: default [performance] powersave[0m

[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1mclang++[0m (PID: 2592970, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 16)
     Drain: [1m[31m4.32 W[0m (22.8% of system, WDI: 36.7) | Primary Domain: [35mCPU Compute[0m
     Causation Mechanism: [1mCore Execution (592 ticks, 50% CPU)[0m
     Physical Metrics   : [2mWakeups: 21/s, RAM PSS: 391MB, Faults: 32 min/s 0 maj/s, Sockets: 0[0m
  2. [1mchrome[0m (PID: 2578706, [36mTier 3 (User App)[0m, 39 thr, Nice: -8)
     Drain: [1m[31m2.32 W[0m (12.2% of system, WDI: 29.9) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (25 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 188/s, RAM PSS: 83MB, Faults: 14 min/s 0 maj/s, Sockets: 25[0m
  3. [1mChatGPT[0m (PID: 2227330, [36mTier 5 (Runaway)[0m, 52 thr, Nice: 10)
     Drain: [1m[33m1.21 W[0m (6.4% of system, WDI: 21.4) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 257/s, RAM PSS: 198MB, Faults: 396 min/s 0 maj/s, Sockets: 32[0m
  4. [1mkwin_wayland[0m (PID: 1116, [36mTier 1 (Compositor)[0m, 41 thr, Nice: -10)
     Drain: [1m[33m0.81 W[0m (4.3% of system, WDI: 21.2) | Primary Domain: [35mCPU C-State Wakeup[0m
     Causation Mechanism: [1mC3 Sleep Breaker (361 wakeups/s)[0m
     Physical Metrics   : [2mWakeups: 361/s, RAM PSS: 56MB, Faults: 26 min/s 0 maj/s, Sockets: 0[0m
  5. [1mchrome[0m (PID: 2578622, [36mTier 3 (User App)[0m, 42 thr, Nice: -8)
     Drain: [1m[33m1.16 W[0m (6.1% of system, WDI: 20.7) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (32 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 248/s, RAM PSS: 165MB, Faults: 10 min/s 0 maj/s, Sockets: 32[0m
  6. [1mChatGPT[0m (PID: 2227409, [36mTier 5 (Runaway)[0m, 28 thr, Nice: 10)
     Drain: [1m[33m1.29 W[0m (6.8% of system, WDI: 19.5) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (14 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 193/s, RAM PSS: 47MB, Faults: 58 min/s 0 maj/s, Sockets: 14[0m
  7. [1mchrome[0m (PID: 2578860, [36mTier 3 (User App)[0m, 25 thr, Nice: 0)
     Drain: [1m[33m1.27 W[0m (6.7% of system, WDI: 16.1) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (11 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 124/s, RAM PSS: 125MB, Faults: 41 min/s 0 maj/s, Sockets: 11[0m
  8. [1mopencode[0m (PID: 2312346, [36mTier 1 (Compositor)[0m, 32 thr, Nice: -5)
     Drain: [1m[33m0.94 W[0m (5.0% of system, WDI: 12.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (16 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 95/s, RAM PSS: 1104MB, Faults: 318 min/s 0 maj/s, Sockets: 16[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (1839 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             47.55 msec task-clock:u                                                          
        10,700,714      cycles:u                                                                (69.00%)
        11,395,130      instructions:u                                                          (68.80%)
           123,864      L1-dcache-load-misses:u                                                 (68.50%)
             3,470      dTLB-load-misses:u                                                      (68.64%)
            94,325      branch-misses:u                                                         (68.65%)
               294      page-faults:u                                                         

       6.050514138 seconds time elapsed

       0.002943000 seconds user
       0.044049000 seconds sys
```
