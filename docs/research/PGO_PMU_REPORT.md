...
=== WattCurb Unit Test Suite & Oracle Gate Verifier ===
 ...
 [ORACLE GATE] Running Deep Battery Drain History Analytics Suite...
   * Analysis Latency (120 pts): 43.612 us
 ...
 [PASS] test_hw_isa_primitives (Core ID=0, TSC=27240530746350)
 ...
 [ORACLE GATE] Dense Battery Telemetry Profiling Benchmark (50000 iters):
   * SIMD uevent parse      : 0.1268 us/op (215.1 cycles/op)
   * Battery physics calc   : 0.0571 us/op
   * Full-scope E2E pipeline: 0.2469 us/op (419.0 cycles/op)
...
--- [REF-TEST-011] Branchless SIMD & BMI2 PDEP Oracle Gate Verification ---
 [ORACLE GATE] Branchless SIMD & BMI2 PDEP parse_proc_stat (50000 iters):
   * Average Parse Latency : 0.1193 us/op
   * Average CPU Cycles    : 202.5 cycles/op
...
--- [REF-TEST-012] C++23 Zero-Cost Environment Abstraction & Policy Verification ---
 ...
 [ORACLE GATE] Zero-Cost Dispatch Latency (50000 iters):
   * Average Latency : 29.84 ns/op
   * Average Cycles  : 50.6 cycles/op
...
--- [REF-TEST-013] Syscall Storm Suppression & Lazy FD Bypass Verification ---
 ...
 [PASS] test_unified_rapid_rollback (AC Plug-in / Charge event full-sweep restoration verified: 727us, idem: 0us)
 [ORACLE GATE] ThinkPower ToolTip Render Latency (50000 iters):
   * Average Latency : 0.0253 us/op
...
--- [REF-TEST-039] Dashboard Matrix Profiling & Zero-Copy Ingestion (REF-REQ-074) ---
 [ORACLE GATE] Matrix Dashboard Telemetry Benchmark:
   * Full JSON Ingestion (1000 iters) : 430.57 us/op (730591.64 cycles/op)
   * Poll Loop Delta Gate (5000 iters) : 11.29 us/op (19157.68 cycles/op)
...
--- [REF-TEST-053] Matrix Dashboard Expanded Power Shares (11 Procs), Full Hardware Visibility & Typography Scaling (REF-REQ-089, REF-ARCH-066) ---
 [ORACLE GATE] 12-Process & Decomposed HW Share Poll Benchmark (50000 iters):
   * Poll + Decomposition Latency: 11.52 us/op (19545.95 cycles/op)
...
--- [REF-TEST-054] Process C-State Affinity Classification & Cyber Badge Telemetry (REF-REQ-090, REF-ARCH-067) ---
 [ORACLE GATE] Process C-State Classification Benchmark (100000 iters):
   * Heuristic Latency: 1.82 ns/op (3.09 cycles/op)
...
--- [REF-TEST-055] Bi-Directional Power Profile Coherence & Seqlock Synchronization (REF-REQ-091, REF-ARCH-068) ---
 [ORACLE GATE] Seqlock Power Profile Coherence Benchmark (100000 iters):
   * Seqlock Update + Read Latency: 2.71 ns/op (4.60 cycles/op)
...
--- [REF-TEST-056] Ultimate Performance Unleash Full-Silicon Actuation Oracle Gate (REF-REQ-092, REF-ARCH-069) ---
 ...
 [ORACLE GATE] Ultimate Performance Actuation Benchmark (10000 iters):
   * PM QoS + GPU Profile Switch Latency: 0.50 ns/op (0.82 cycles/op)
...
--- [REF-TEST-059] Audio Continuity Guarantee (REF-REQ-096) ---
   ...
   * PCM probe                 : 43.0 us/op, active=no, owners=0
...
--- [REF-TEST-062] Audit Defect Remediation (REF-REQ-111, REF-RES-029) ---
   * Process identity readable (start_time=18960960 ticks)
...
--- [REF-TEST-071] Performance Swap Expansion Policy (REF-REQ-113) ---
 [PAS[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (konsole) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 () | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487629 (bench) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
[2026-09-26 21:27:46] [WATTCURB][MITIGATION] Mitigation Actuated: PID 487630 (sandbox-probe) | Action: ACTIVE_WINDOW_C0_GUARANTEE | Details: Pinned to C1 cores, nice -10, PM QoS 0us C0 clamp
...
--- [REF-TEST-041] Multilingual L10n & Auto System Locale Verification ---
 ...
 [ORACLE GATE] Headroom Mask Computation Benchmark (50000 iters):
   * Average Latency : 0.0044 us/op
   * Average Cycles  : 7.4 cycles/op
...
--- [REF-TEST-049] KDE Active Window Resource Guarantee & PM QoS C0 Pinning Verification ---
 [ORACLE GATE] Active Window Guarantee Benchmark:
   ...
   * Total Time      : 17789.5 us
   * Average Latency : 8.8948 us/op
 [PASS] test_active_window_resource_guarantee_and_c0_qos (REF-TEST-049: C0 Pinning, C1 Spatial Affinity, 8.8948 us/op)
...
--- [REF-TEST-020] Dual-Domain State Journaling & Faithful Restoration Verification ---
 ...
 [ORACLE GATE] EventLogger Stack Formatting (50k iters): 0.4775 us/op
 [ORACLE GATE] HistoryRingBuffer Append Latency (100k iters): 7.4965 ns/op
 ...
 [ORACLE GATE] UltraEndurance Profile Actuation & 100% Roundtrip: 3.9730 ms
 [PASS] test_ultra_endurance_extensions (REF-TEST-028: SMT, Bluetooth, Backlight Cap, DRRS, KWin Effects & Baloo verified)
 [ORACLE GATE] Platform Loss Decomposition (12.5W System -> 3.8W Plat): DRAM=1.3641W, VRM[2026-09-26 21:27:46] [WATTCURB][ALERT:WARN] CPU frequency starved under load: max core 0 MHz vs ceiling 1700 MHz, load1=5.74, profile=Performance; ceiling/profile were already at target, SMU re-apply refused (baseline not captured); SMU baseline STAPM 0 mW (REF-REQ-112.10, REF-REQ-115.2)
=1.6864W, Wi-Fi=0.5247W, MB/IO=0.2249W (Invariant Sum=3.8000W)
...
--- [REF-TEST-057] Deterministic Battery Threshold Demotion (REF-REQ-094) ---
 ...
 [ORACLE GATE] Tier 2 Ultra-Lightweight Probe Latency: 1889.4969 us/op
...
--- [REF-TEST-014] Adaptive Power State Machine & Dynamic Rollback Verification ---
 ...
 [INFO] Hardware Probe Sample Captured:
   ...
   - CPU Cores Online: 16, Avg Freq: 1850 MHz
   - C-State POLL=231913017us, C1=6914305884us, C2=328020651181us, C3=542257149180us
   - GPU Power: 11.000000 W
   - GPU Busy: 0%
   - Fan RPM: 2671
   - Battery Discharging: false, AC Online: true
   - Battery Health: 94.191696%
   - NVMe Status: active, Read sectors: 2012837383
 ...
 [ORACLE GATE] 100k stat parses completed in 11850 us (0.1185 us/op)
...
=== ALL TESTS & ORACLE GATE PASSED SUCCESSFULLY ===
 ...
 Performance counter stats for '/home/jedclub/Develop/WattCurb/build_pgo/wattcurb_tests':
          ...
          1,386.01 msec task-clock:u                                                          
     4,271,362,104      cycles:u                                                                (85.73%)
     9,199,662,220      instructions:u                                                          (85.73%)
         6,987,337      cache-misses:u                                                          (85.72%)
        61,721,262      L1-dcache-load-misses:u                                                 (85.78%)
           522,987      dTLB-load-misses:u                                                      (85.60%)
     2,170,579,287      branches:u                                                              (85.83%)
        12,473,919      branch-misses:u                                                         (85.73%)

       1.559273389 seconds time elapsed

       1.138692000 seconds user
       0.232189000 seconds sys
```
...
================================================================================================================
[0m[2m Observation Scope    : [0m[1m6040 ms[0m[2m (3 continuous intervals)[0m[2m | Energy Consumption: [0m[1m98.57 Joules[0m[2m | Monitored Processes: [0m[1m130[0m[2m | Wakeups: [0m[1m536 /sec[0m

[1m [1] System Battery & Power Supply Deep Telemetry[0m
  - Total System Drain      : [1m[33m16.32 Watts[0m[1m[32m [AC Hardware Pass-Through Active: Zero Battery Wear][0m
...
[1m [2] Physical Hardware Domain Power & State Breakdown[0m
  * CPU Package (RAPL)    :  12.32 W ( 75.5%) [2mTemp: 64°C, 1485 MHz avg (schedutil)[0m
    └─ [2mC-State Sleep Residency : [0mC0 (Active): [1m4.6%[0m, C1: 0.1%, C2: 7.3%, C3 (Deep Sleep): [1m[32m88.0%[0m
  * GPU Silicon (DRM)     :   0.05 W (  0.3%) [2mBusy: 0%, 367 MB VRAM, 8.0 GT/s PCIe x16[0m
  * Display Backlight     :   1.90 W ( 11.7%) [2mBrightness: 38%[0m
  * Storage / NVMe APST   :   0.35 W (  2.2%) [2mNVMe: active (Read 0.0 MB/s, Write 0.1 MB/s)[0m
  * Mechanical Fan        :   0.49 W (  3.0%) [2m2671 RPM[0m
...
[1m [3] Top Battery Drain Culprits & Physical Causation Breakdown[0m
  1. [1magy[0m (PID: 48310, [36mTier 1 (Compositor)[0m, 27 thr, Nice: -5)
     Drain: [1m[31m7.44 W[0m (45.6% of system, WDI: 62.5) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (12 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 44/s, RAM PSS: 361MB, Faults: 1267 min/s 0 maj/s, Sockets: 12[0m
  2. [1mplasmashell[0m (PID: 77134, [36mTier 2 (Shell)[0m, 55 thr, Nice: -6)
     Drain: [1m[33m1.22 W[0m (7.4% of system, WDI: 12.3) | Primary Domain: [35mWiFi Radio CAM[0m
     Causation Mechanism: [1mActive Network Sockets (12 skt, CAM Mode)[0m
     Physical Metrics   : [2mWakeups: 47/s, RAM PSS: 142MB, Faults: 0 min/s 0 maj/s, Sockets: 12[0m
  3. [1mchrome[0m (PID: 26988, [36mTier 3 (User App)[0m, 28 thr, Nice: 5)
     Drain: [1m[32m0.11 W[0m (0.7% of system, WDI: 5.1) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (3 w/s)[0m
     Physical Metrics   : [2mWakeups: 3/s, RAM PSS: 94MB, Faults: 73 min/s 1 maj/s, Sockets: 12[0m
  4. [1mksystemstats[0m (PID: 77200, [36mTier 4 (Bg Worker)[0m, 3 thr, Nice: 0)
     Drain: [1m[32m0.43 W[0m (2.6% of system, WDI: 4.8) | Primary Domain: [35mNVMe Storage[0m
     Causation Mechanism: [1mNVMe Active (0.00 MB/s)[0m
     Physical Metrics   : [2mWakeups: 23/s, RAM PSS: 5MB, Faults: 0 min/s 0 maj/s, Sockets: 5[0m
  5. [1mopencode[0m (PID: 175908, [36mTier 1 (Compositor)[0m, 20 thr, Nice: -5)
     Drain: [1m[32m0.43 W[0m (2.6% of system, WDI: 4.5) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (15 w/s)[0m
     Physical Metrics   : [2mWakeups: 15/s, RAM PSS: 249MB, Faults: 64 min/s 0 maj/s, Sockets: 4[0m
  6. [1mflownect[0m (PID: 380928, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -5)
     Drain: [1m[32m0.25 W[0m (1.5% of system, WDI: 4.2) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (49 w/s)[0m
     Physical Metrics   : [2mWakeups: 49/s, RAM PSS: 1MB, Faults: 0 min/s 0 maj/s, Sockets: 1[0m
  7. [1mflownect[0m (PID: 380390, [36mTier 5 (Runaway)[0m, 1 thr, Nice: 10)
     Drain: [1m[32m0.25 W[0m (1.5% of system, WDI: 4.2) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (49 w/s)[0m
     Physical Metrics   : [2mWakeups: 49/s, RAM PSS: 1MB, Faults: 0 min/s 0 maj/s, Sockets: 1[0m
  8. [1mflownect[0m (PID: 379001, [36mTier 5 (Runaway)[0m, 1 thr, Nice: -5)
     Drain: [1m[32m0.25 W[0m (1.5% of system, WDI: 4.2) | Primary Domain: [35mPlatform/Idle[0m
     Causation Mechanism: [1mBackground Poll (49 w/s)[0m
     Physical Metrics   : [2mWakeups: 49/s, RAM PSS: 1MB, Faults: 0 min/s 0 maj/s, Sockets: 1[0m
...
[1m [5] Actionable Engineering Recommendations[0m
  * [C-State Breaker] Wakeup frequency (536 wakeups/sec) is impeding CPU C3 deep sleep. Enabling TimerSlackCoalescing will bundle timers.
================================================================================================================


 Performance counter stats for '/home/jedclub/Develop/WattCurb/output/wattcurb --duration 6 -i 2':

             51.85 msec task-clock:u                                                          
         6,558,272      cycles:u                                                              
         7,240,005      instructions:u                                                        
            79,948      L1-dcache-load-misses:u                                               
             2,906      dTLB-load-misses:u                                                    
            60,821      branch-misses:u                                                       
               290      page-faults:u                                                         

       6.057699385 seconds time elapsed

       0.003059000 seconds user
       0.049115000 seconds sys
```
