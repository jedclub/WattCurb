...
| [`REF-ARCH-005`](file:///home/jedclub/Develop/WattCurb/docs/architecture/ARCH-005-zero-cost-cpuid-simd.md) | C++23 Zero-Cost CPUID Query & Constant-Branch Specialization Architecture | CPUID Bitmask, NTTP Dispatch, clzero, rdpid, SIMD | Approved |
| [`REF-ARCH-006`](file:///home/jedclub/Develop/WattCurb/docs/architecture/ARCH-006-portable-binary-zero-overhead-dispatch.md) | Pre-Built Binary Distribution: Zero-Overhead Hardware Specialization Architecture | GNU IFUNC, NTTP Outer-Loop Specialization, target_clones | Approved |
